		...
		rcp_type_ref key_type, rcp_type_ref value_type)
{
	...
	rcp_map_ref core = (rcp_map_ref)rcp_record_data(rec);
...
rcp_map_ref rcp_map_new(
		rcp_type_ref key_type, rcp_type_ref value_type)
{
	rcp_map_ref map = (rcp_map_ref)rcp_alloc(rcp_map_type);
...
rcp_extern void rcp_map_delete(
		rcp_map_ref map)
{
	rcp_delete(rcp_map_type, (rcp_data_ref)map);
}
void rcp_map_init(rcp_type_ref type, rcp_data_ref data)
{
	rcp_map_ref core = (rcp_map_ref)data;
	core->key_type = NULL;
...
void rcp_map_deinit(rcp_type_ref type, rcp_data_ref data)
{
	...
	rcp_tree_deinit(&(map->t_core));
}

void rcp_map_init_with_type(rcp_map_ref map, 
		rcp_type_ref key_type, rcp_type_ref value_type)
{
	rcp_map_ref core = map;
#ifdef RCP_SELF_TEST
	if ( ! key_type)
...
{
	return (rcp_map_node_ref)rcp_tree_find(&(map->t_core), key);
}

rcp_map_node_ref rcp_map_set(rcp_map_ref map, rcp_map_node_ref node)
{
	return (rcp_map_node_ref)
		rcp_tree_set(&(map->t_core),(rcp_tree_node_ref)node);
}

rcp_extern rcp_map_node_ref rcp_map_begin(rcp_map_ref map)
{
	return (rcp_map_node_ref)rcp_tree_begin(&(map->t_core));
}
...
rcp_map_node_ref rcp_map_node_new(rcp_map_ref map)
{
	...
	rcp_map_node_ref node = (rcp_map_node_ref)rcp_tree_node_new(s);
...
rcp_data_ref rcp_map_node_key(
	...
	return rcp_tree_node_data((rcp_tree_node_ref)node);
}
rcp_data_ref rcp_map_node_value(
		rcp_map_ref map, rcp_map_node_ref node){
	rcp_type_ref key_type = rcp_map_key_type(map);
	return (void*)rcp_map_node_key(map, node) + key_type->size;
}
rcp_extern rcp_map_node_ref rcp_map_node_next(rcp_map_node_ref node){
	return (rcp_map_node_ref)rcp_tree_node_next((rcp_tree_node_ref)node);
}
